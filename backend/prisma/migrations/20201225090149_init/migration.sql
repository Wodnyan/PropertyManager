/*
  ...
  - Added the required column `created_at` to the `Property` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `created_at` to the `Tenant` table without a default value. This is not possible if the table is not empty.
